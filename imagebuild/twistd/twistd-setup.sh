...
env PYTHONPATH=$PYTHONPATH $NSCALEPREFIX/bin/easy_install --prefix=$NSCALEPREFIX Twisted
env PYTHONPATH=$PYTHONPATH $NSCALEPREFIX/bin/easy_install --prefix=$NSCALEPREFIX simplejson
